...
set files [list \
 ...
 "[file normalize "$origin_dir/src/vhdl/lcdtest.vhdl"]"\
...
set file "[file normalize "$origin_dir/src/vhdl/lcdtest.xdc"]"
set file_imported [add_files -fileset constrs_1 $file]
set file "vhdl/lcdtest.xdc"

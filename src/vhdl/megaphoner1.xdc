...
# LCD display
set_property -dict {PACKAGE_PIN A6 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_red[0]}]
set_property -dict {PACKAGE_PIN A5 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_red[1]}]
set_property -dict {PACKAGE_PIN D5 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_red[2]}]
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_red[3]}]
set_property -dict {PACKAGE_PIN A4 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_red[4]}]
set_property -dict {PACKAGE_PIN A3 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_red[5]}]

set_property -dict {PACKAGE_PIN B2 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_green[0]}]
set_property -dict {PACKAGE_PIN B3 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_green[1]}]
set_property -dict {PACKAGE_PIN B1 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_green[2]}]
set_property -dict {PACKAGE_PIN A1 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_green[3]}]
set_property -dict {PACKAGE_PIN C1 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_green[4]}]
set_property -dict {PACKAGE_PIN C2 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_green[5]}]

set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_blue[0]}]
set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_blue[1]}]
set_property -dict {PACKAGE_PIN F1 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_blue[2]}]
set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_blue[3]}]
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_blue[4]}]
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports {lcd_blue[5]}]
...
set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports lcd_hsync]
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports lcd_vsync]
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports lcd_display_enable]
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 4} [get_ports lcd_pwm]
...
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[0]}]
set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[1]}]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[2]}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[3]}]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[4]}]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[5]}]
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[6]}]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports {hr_d[7]}]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports hr_rwds]
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports hr_rsto]
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports hr_reset]
#set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 4} [get_ports hr_int]
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports hr_clk_p]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS18 PULLUP FALSE SLEW FAST DRIVE 4} [get_ports hr_clk_n]
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 4} [get_ports hr_cs0]
#set_property -dict {PACKAGE_PIN  IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports hr_cs1]

...
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[0]}]
set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[1]}]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[2]}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[3]}]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[4]}]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[5]}]
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[6]}]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports {hr_d[7]}]
...
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS18 PULLUP FALSE DRIVE 24} [get_ports hr_cs1]
